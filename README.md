...
3. login AWS, select [AWS API Gateway](https://aws.amazon.com/api-gateway/). Create API by [Import from Swagger], select the Swagger script from [API Gateway Swagger Script](https://github.com/xiaodongliang/Forge-workflow-Lambda-APIGateway/blob/master/API%20Gateway/Xiaodong-Forge-Test-swagger-integrations%2Cauthorizers%2Cdocumentation%2Cvalidators%2Cgatewayresponses.json)
